...
//      let panel = this.provisioningCheckerView.getElement()
      let stdout = function(output) {
        ...
        let passEditorElement = document.getElementsByClassName('p12-password')[0].getElementsByClassName('p12-pass-editor');
        // https://github.com/atom/atom-keymap
        console.log(passEditorElement);
        passEditorElement[0].addEventListener('keydown', function(event) {
          console.log(event)
          if (event.key == 'Enter') {
